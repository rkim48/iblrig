        ...
        function groups = getPropertyGroups(obj)
            if ~isscalar(obj)
                ...
                if ~isempty(obj.GroupData)
                    ...
                    nonEmptyLegendLabels = obj.LegendLabels ~= "" & ~ismissing(obj.LegendLabels);
                    if any(nonEmptyLegendLabels)
                        propList{end+1} = 'LegendLabels';
                    end
